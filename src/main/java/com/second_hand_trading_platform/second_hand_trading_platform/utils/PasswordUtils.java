...
public class PasswordUtils {
    ...
    public static boolean isValidToken(String token,String tokenCMP,long authTime) {
        long l = System.currentTimeMillis() - authTime;
        boolean b = token.equalsIgnoreCase(tokenCMP);
        return (System.currentTimeMillis() - authTime  <= MAX_TIME_VALUE) && token.equalsIgnoreCase(tokenCMP);
    }
}